...
<# Begin: DataSource "EntraID-AFAS-account-update-phone-lookup-user-generate-table" #>
$tmpPsScript = @'
#######################################################################
...
'@ 
$tmpModel = @'
[{"key":"BusinessPhones","type":0},{"key":"MobilePhone","type":0},{"key":"DisplayName","type":0},{"key":"Department","type":0},{"key":"Id","type":0},{"key":"UserPrincipalName","type":0},{"key":"EmployeeID","type":0},{"key":"Title","type":0},{"key":"Company","type":0}]
'@ 
$tmpInput = @'
